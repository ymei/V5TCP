...
proc add_source_files {} {
   ...
   xfile add "../test_bench/ads5282_interface_tb.vhd"
   xfile add "../test_bench/fifo_rdwidth_reducer_tb.vhd"
   xfile add "../test_bench/sdram_buffer_fifo_tb.vhd"
   xfile add "../test_bench/shiftreg_drive_tb.vhd"
   xfile add "../test_bench/width_pulse_sync_tb.vhd"
   puts ""
...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "/home/software/Xilinx/14.7/ISE_DS/ISE/data/default.xds"
   ...
   project set "Work Directory" "/home/ymei/Work/UltrafastImaging/V5TCP/top/xst" -process "Synthesize - XST"
