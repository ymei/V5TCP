# 
# Project automation script for V5TCP 
# 
...
proc add_source_files {} {
   ...
   xfile add "../ipcore_dir/bram_sdp_w32r8.xco"
   xfile add "../ipcore_dir/clock_generator.xaw"
   ...
   xfile add "../ipcore_dir/fifo32comclk.xco"
   xfile add "../ipcore_dir/fifo32to8.xco"
   xfile add "../ipcore_dir/fifo36x512.xco"
   xfile add "../ipcore_dir/fifo8to32.xco"
   xfile add "../ipcore_dir/fifo96.xco"
   xfile add "../ipcore_dir/mig.xco"
   xfile add "../src/ads5282_interface.vhd"
   xfile add "../src/byte2cmd.vhd"
   xfile add "../src/channel_decim.vhd"
   xfile add "../src/common_pkg.vhd"
   xfile add "../src/control_interface.vhd"
   xfile add "../src/edge_sync.vhd"
   xfile add "../src/fifo2shiftreg.vhd"
   xfile add "../src/fifo_rdwidth_reducer.vhd"
   xfile add "../src/gig_eth/V5EMAC/V5EMAC.vhd"
   xfile add "../src/gig_eth/V5EMAC/V5EMAC_block.vhd"
   xfile add "../src/gig_eth/V5EMAC/V5EMAC_locallink.vhd"
   xfile add "../src/gig_eth/V5EMAC/client/fifo/eth_fifo_8.vhd"
   xfile add "../src/gig_eth/V5EMAC/client/fifo/rx_client_fifo_8.vhd"
   xfile add "../src/gig_eth/V5EMAC/client/fifo/tx_client_fifo_8.vhd"
   xfile add "../src/gig_eth/V5EMAC/physical/emac0_fcs_blk_mii.vhd"
   xfile add "../src/gig_eth/V5EMAC/physical/gmii_if.vhd"
   xfile add "../src/gig_eth/emac.vhd"
   xfile add "../src/gig_eth/gig_eth.vhd"
   xfile add "../src/gig_eth/tcp_server/arp.vhd"
   xfile add "../src/gig_eth/tcp_server/arp_cache2.vhd"
   xfile add "../src/gig_eth/tcp_server/bram_dp.vhd"
   xfile add "../src/gig_eth/tcp_server/com5402.vhd"
   xfile add "../src/gig_eth/tcp_server/com5402pkg.vhd"
   xfile add "../src/gig_eth/tcp_server/packet_parsing.vhd"
   xfile add "../src/gig_eth/tcp_server/ping.vhd"
   xfile add "../src/gig_eth/tcp_server/serial2udp_tx.vhd"
   xfile add "../src/gig_eth/tcp_server/tcp_rxbufndemux2.vhd"
   xfile add "../src/gig_eth/tcp_server/tcp_server.vhd"
   xfile add "../src/gig_eth/tcp_server/tcp_tx.vhd"
   xfile add "../src/gig_eth/tcp_server/tcp_txbuf.vhd"
   xfile add "../src/gig_eth/tcp_server/timer_4us.vhd"
   xfile add "../src/gig_eth/tcp_server/udp2serial.vhd"
   xfile add "../src/gig_eth/tcp_server/udp_rx.vhd"
   xfile add "../src/gig_eth/tcp_server/whois2.vhd"
   xfile add "../src/global_resetter.vhd"
   xfile add "../src/pulse2pulse.vhd"
   xfile add "../src/pulsegen.vhd"
   xfile add "../src/sdram_ddr2/sdram_buffer_fifo.vhd"
   xfile add "../src/sdram_ddr2/sdram_ddr2.vhd"
   xfile add "../src/shiftreg_drive.vhd"
   xfile add "../src/tickgen.vhd"
   xfile add "../src/top.ucf"
   xfile add "../src/top.vhd"
   xfile add "../src/topmetal_iiminus_analog.vhd"
   xfile add "../src/uartio.vhd"
   xfile add "../src/width_pulse_sync.vhd"
...
proc set_process_props {} {
   ...
   project set "Last Applied Strategy" "Performance with IOB Packing;C:/Xilinx/14.7/ISE_DS/ISE/virtex5/data/virtex5_performance_with_iobpacking.xds"
   ...
   project set "User Browsed Strategy Files" "C:/Xilinx/14.7/ISE_DS/ISE/virtex5/data/virtex5_performance_with_iobpacking.xds"
   ...
   project set "Work Directory" "D:/VMShared/V5TCP/top/xst" -process "Synthesize - XST"
